...
class TestRegression(unittest.TestCase):
    ...
    def test_linear_fit_SGD(self):
        ...
        # print('rmse: ' + str(reg.rmse(linear_SGD,test_reg.linear_SGD)))
        # print('my values: ' + str(linear_SGD))
        # print('test values: ' + str(test_reg.linear_SGD))
        # print(linear_SGD / test_reg.linear_SGD)
    ...
    def test_ridge_fit_closed(self):
        ...
        reg = Regression()
        test_reg = Regression_Test()
        #print('rmse: ' + str(reg.rmse(reg.ridge_fit_closed(test_reg.x_all_feat, test_reg.y_all, 10),test_reg.ridge_closed)))
    ...
    def test_ridge_fit_SGD(self):
        ...
        # print('rmse: ' + str(reg.rmse(ridge_SGD,test_reg.ridge_SGD)))
        # print('my values: ' + str(ridge_SGD))
        # print('test values: ' + str(test_reg.ridge_SGD))
        # print(ridge_SGD / test_reg.ridge_SGD)
